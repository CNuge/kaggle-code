...
with tf.variable_scope('ClassNet'):
	...
	#make the number of classes == 1 and see how this affects the scoring?
	#the learning rate could also be upped to .1
	#seems to be working at improving the GINI with the sigmoid final, but it is
	#improving at a very very slow rate
...
dnn_output.to_csv('tf_dnn_predictions4.csv', index=False, float_format='%.10f')
